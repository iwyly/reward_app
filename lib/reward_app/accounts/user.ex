defmodule RewardApp.Accounts.User do
  ...
  schema "users" do
    ...
    field :reward_pool, :integer, default: 50
    timestamps()
  end
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, RewardApp.Repo)
  ...
  """
  def valid_password?(%RewardApp.Accounts.User{hashed_password: hashed_password}, password)
